...
const menuItemsSection = {
    ...
    items: {
        menuItemMergeModeInfo: {
            component: 'text',
            label: 'When multiple HelpButton.qs objects are active in the same page session, their toolbar menu items can be appended or de-duplicated.',
        },
        menuItemMergeMode: {
                    ...
                    items: {
                        ...
                        brPayloadFieldsSection: {
                            ...
                            items: {
                                brPfInfo: {
                                    component: 'text',
                                    label: 'Fields included in the webhook POST payload (may differ from dialog).',
                                },
                                brPfUserName: {
