...
- [Property Panel Reference](#property-panel-reference)
    ...
    - [Menu Items](#menu-items)
        - [Common properties for each `menuItems[]` item](#common-properties-for-each-menuitems-item)
        - [When action-specific menu item fields appear](#when-action-specific-menu-item-fields-appear)
        - [Bug Report Settings (`action = bugReport`)](#bug-report-settings-action--bugreport)
        ...
        - [Feedback Settings (`action = feedback`)](#feedback-settings-action--feedback)
        ...
        - [Variable Settings (`action = setVariable`)](#variable-settings-action--setvariable)
        - [Item Colors (all menu item actions)](#item-colors-all-menu-item-actions)
    - [Tooltips](#tooltips)
        - [Common properties for each `tooltips[]` item](#common-properties-for-each-tooltips-item)
...
| Authentication                             | `bugReport.authStrategy`           | Dropdown       | `none`                | `action = bugReport`                                       | Options: `none`, `header`, `custom`.                            |
| Header token                               | `bugReport.authToken`              | String         | `""`                  | `action = bugReport` and `bugReport.authStrategy = header` | Supports expressions. Max 8192 chars.                           |
...
| Authentication                           | `feedback.authStrategy`           | Dropdown       | `none`                | `action = feedback`                                        | Options: `none`, `header`, `custom`.                            |
| Header token                             | `feedback.authToken`              | String         | `""`                  | `action = feedback` and `feedback.authStrategy = header`   | Supports expressions. Max 8192 chars.                           |
