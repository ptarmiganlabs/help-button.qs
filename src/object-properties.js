...
function createDefaultPayloadKeyNames() {
  return {
    ...
    status: "status",
    picture: "picture",
    preferredZoneinfo: "preferredZoneinfo",
    roles: "roles",
  };
}
  ...
  tooltips: [
    {
      ...
      hoverContent:
        "This is the **sheet name**. Rename it in the sheet properties panel. Click on this icon for more info about navigating between sheets.",
      dialogEnabled: true,
